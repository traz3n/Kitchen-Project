...
public class GUIDesign extends JFrame {
	...
	// detection function to automatically check and transfer items to shopping list
	// if insufficient
	private void MinAdd() {
		...
		for (int x = 0; x < dtm.getRowCount(); x++) {
			...
			if (Integer.parseInt((String) dtm.getValueAt(x, 3)) < 1) {
				...
				int n = JOptionPane.showOptionDialog(null,
						"We have found item/s with 0 quantity. Would you like to add to shopping list?", "Choose",
				...
				if (n == 0) {
					// input value
					String minimumconfirm1 = JOptionPane
							.showInputDialog("How many " + dtm.getValueAt(x, 0) + " would you like to buy?");
