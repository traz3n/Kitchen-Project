...
public class RecipeList extends JFrame{
	...
	public RecipeList() {
		...
		JButton ILadd_1_1 = new JButton("Recipe 1"); //determines which recipe is selected and changes state of the window
		...
		JButton ILadd_1_2 = new JButton("Recipe 2"); //determines which recipe is selected and changes state of the window
		...
		JButton btnIngredientChecker = new JButton("Checker"); //automatic add button to shopping list if ingredients are insufficient upon scanning inventory
...
//function to check inventory for ingredients and adds to shopping list if none are found (for recipe 1)	
...
//function to check inventory for ingredients and adds to shopping list if none are found (for recipe 2)		
